                ...
                <div className="col-lg-12 col-md-12">
                  <div className="section-title">
                    ...
                    <p className="text-justify pt-3 pb-3">
                      ...
                      Professionals , Management Analyst's , BDM , Corporate
                      Trainers , Sales and Admin Professionals , And Network
                      Engineers.
                    </p>
                    <p className="text-justify pt-3 pb-3">
                      We believe in the simple mechanism of 'Righteous Business'
                      and are developing our Goodwill through Team efforts ,
                      Assured Solutions , Dignity , Quality , On-Time
                      Implementation , Procedural Management , Self Belief &amp;
                      reliance and Fair Business Practises.
                    </p>
                    <p className="text-justify pt-3 pb-3">
                ...
                <div className="col-lg-12 col-12">
                  <div className="position-relative">
                    <img
                      ...
                      src="https://www.tallysolution.net/assets/images/team.jpg"
